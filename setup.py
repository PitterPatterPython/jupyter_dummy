...
version_ns = {}
integration_str = "dummy" # This could change to hive, drill, elastic etc.
...
setup_args = dict(
    ...
    long_description="A magic function for working with Dummy Datasets for Python3 based Jupyter Notebooks",
    author="John Omernik",
